...
declare @LDate datetime = '2021-01-01 00:00:59.637'
declare @UDate datetime = '2021-02-28 23:59:59.637'
...
and left(pb.param1,5)='LABEL'
and ( pb.Param1 like '%LABEL/21-0410%' or pb.Param1 like '%LABEL/21-0411%' or pb.Param1 like '%LABEL/21-0412%' ) 


) as w
where w.ReferenceNo in ('R-27536520002/210330306','R-27536520001/210340306','R-27489650004/271520300')
order by pos asc, ReferenceNo, DocDate option (optimize for unknown)
