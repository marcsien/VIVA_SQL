...
declare @UDate as datetime = '2020-07-30 23:59:59'

/*dodalem zeby nie zaciagalo zwrotow*/
	...
	, replace(replace(convert(nvarchar,convert(money,isnull((select sum(PDPD1.Quantity) 
																from (select dpd.ProductBatchId
																	...
																	where d.Deleted is null and dpd.Deleted is null and d.DocumentStatusId <>'95D50618-26B8-4B48-9146-BC983A8E8EDE'
																		...
																		--niezwroty aneta o 
																		and not(
																		dpd.WarehouseDstId is null and dpd.WarehouseSrcId = '0B26B42E-91E1-42AE-BE4D-17F4619F766A' and ds.Name = 'RWT SCRAP'
																		or 
																		dpd.WarehouseDstId = '0B26B42E-91E1-42AE-BE4D-17F4619F766A' and dpd.WarehouseSrcId is null and ds.Name = 'PZT'
																		)
...
--where w.ReferenceNo = 'FT/20-0344/01'
