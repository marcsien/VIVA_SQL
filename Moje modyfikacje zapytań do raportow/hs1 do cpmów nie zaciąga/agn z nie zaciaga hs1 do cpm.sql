use Synaptic
declare @CurrentDate date = '2020-05-20'
...
AND MO.ManufacturingOperationTypeId in 
(SELECT Id FROM ManufacturingOperationType (NOLOCK) WHERE Name = 'Rejestracja Produkcji CPM/SSPM' or Name = 'Rejestracja produkcji INNE STANOWISKA')
