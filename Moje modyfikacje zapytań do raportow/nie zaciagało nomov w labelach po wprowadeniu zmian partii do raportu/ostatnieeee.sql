...
--select * from ProductBatch pb where pb.Param3 like '%meiyume%' and (pb.Param2 = 'R-22919400001' or pb.Param2 ='R-22847730001') and pb.Id in
...
select * from (
 ...
 where ddd.id = 'A27D9470-948B-43FA-B088-FAA600D5EE77'

 or ddd.DID = '23548658-F6ED-4596-A1DC-41E4749B4593'
 order by ddd.RealizationDate desc 
...
/*
							...
							where NOMOV.Quantity > 0
								and NOMOV.Id not in --warunek zeby nie zaciagalo nomovment ze zmian partii tutej222f
								(select pb.Id 
								from Document d
