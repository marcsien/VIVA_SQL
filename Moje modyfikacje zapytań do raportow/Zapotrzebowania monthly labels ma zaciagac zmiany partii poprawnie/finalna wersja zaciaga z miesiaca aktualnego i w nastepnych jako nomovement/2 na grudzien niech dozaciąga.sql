use Synaptic
declare @LDate as datetime = '2019-11-01 00:00:01'
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED -- zakomentuj to , no lock dla calego zapytania na czas tylko testow
...
/*ogranicza tylko do dokumentów z tego okresu*/
		...
		where d.Deleted is null 
			...
			and ds.IsStockChange=0
			and d.Realizated is not null
			and d.DeadlineDate >@LDate and d.DeadlineDate<@UDate ------------------------------ tutej111
			and ds.IsPZ=0 
			and ds.IsPW=0
			and ds.iswz=0
			and ds.IsBatchChange = 1
...
where w.ReferenceNo = 'R-22847730001'
