...
/*Etykiety dodany stan blocked i availible, do availible liczy mmki przesuniêcia na stan z mag zewnêtrznego i qc + pozosta³e dokumenty we wy na magazyny surowców prodyukcji itp*/
...
/*ogranicza tylko do dokumentów z tego okresu*/
		group by dpd.ProductDefinitionId, dpd.ProductBatchId,d.DocumentNumber,d.DocumentPreNumber, ds.IsPW, ds.IsPZ, ds.IsRW, d.DeadlineDate, d.RealizationDate, dpd.DocumentId, dpd.OrderNumber, ds.IsMM, dpd.WarehouseDstId, dpd.WarehouseSrcId
...
where w.Reference4 like '%meiyume%'
